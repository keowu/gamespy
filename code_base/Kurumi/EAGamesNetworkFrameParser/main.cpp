...
auto Bf1942Work() -> void {

    std::cout << "Hello World!\n";

    std::string path("C:\\Users\\joaov\\source\\repos\\Kurumi\\GamespyMasterServer\\payload.bin");
...
auto BfVietnamWork() -> void {

    std::string path("C:\\Users\\joaov\\source\\repos\\Kurumi\\GamespyMasterServer\\payload3.bin");
